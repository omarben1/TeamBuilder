...
public class TeamBuilderApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		ur.save(user);
		tr.save(new Team(5, "helloTeam", "awesome team where we will work togrther to do something amazing", 9, user,
				null));
		User user1 = new User(1, "hicham", "hh", "hicham@email.com", null);
		ur.save(user);
		tr.save(new Team(5, "myTeam", "nothing to say just join us plz", 3, user, null));
		User user2 = new User(1, "ff", "offr", "off@email.com", null);
		ur.save(user);
		tr.save(new Team(5, "welcome", "You are welcome to join us", 9, user, null));
	}
